    ...
    public static class CinematicTable
    {
        ...
        private static readonly Def CS1 = new Def
        {
            ...
            cuts = new[]
            {
                ...
                new Cut(null, "Cut_S_N1_04", "마을 사람들은 나를 지나쳐 걸었다. 인사를 해도 아무도 대답하지 않았다. 이 마을에서 나는 낯선 사람이었다.", 8.5f, false, null, "Cut_V_CH03_Open", 1),
        ...
        private static readonly Def CS3 = new Def
        {
            ...
            cuts = new[]
            {
                ...
                new Cut(null, "Cut_S_N3_04", "밤의 탑 아래 그가 혼자 앉아 있었다. 어깨를 잡으려다 손을 멈췄다. 그때는 아직 부를 이름이 없었다.", 8.5f, false, null, "Cut_V_CH18_Mid", 1),
                new Cut(null, "Cut_S_N3_05", "첫눈 오는 날, 꼬마와 창가에서 성에에 얼굴을 그렸다. 둘을 그리다 손이 멈췄다. 나머지 하나가 누군지 몰라서.", 8.5f, false, null, "Cut_V_CH17_Open", 0),
                new Cut(null, "Cut_S_N3_06", "눈 위엔 꼬마 발자국만 또렷했다. 내 자리는 돌아보면 벌써 눈에 덮여 있었다. 그날은 눈이 참 빨리 쌓였다.", 8.5f, false, null, "Cut_V_CH07_Open", 3),
        ...
        private static readonly Def CS5 = new Def
        {
            ...
            cuts = new[]
            {
                ...
                new Cut(null, "Cut_S_N5_03", "트럭이 바로 옆을 스쳤고 나는 길 옆으로 넘어졌다. 나를 밀어낸 건 꼬마였다. 그날부터 우비 소매가 찢어져 있었다.", 8.5f, false, null, "Cut_CS5_3", 2),
                ...
                new Cut(null, "Cut_S_N5_06", "폭우의 밤. 마당에 엄마가 엎어져 있었다. 심장병이었다. 그 애가 먼저 보고 소리를 질렀다.", 8.5f, true, "— 회상 · 여덟 해 전 —", "Cut_V_CH13_Open", 0),
        ...
        private static readonly Def CS6 = new Def
        {
            ...
            cuts = new[]
            {
                ...
                new Cut(null, "Cut_S_N6_11", "파도는 조용히 왔다. 기억은 거기서 끊긴다. 눈을 뜬 곳이 그 방이었다. 나는 내가 살아 돌아온 줄로만 알았다.", 8.5f, false, null, "Cut_CS6_7", 1),
        ...
        private static readonly Def CS7 = new Def
        {
            ...
            cuts = new[]
            {
                ...
                new Cut(null, "Cut_S_N7_03", "그는 새벽마다 약을 한 움큼 삼켰다. 손목의 병원 팔찌는 끊긴 적이 없었다. 이 사람, 얼마나 남은 걸까.", 8.5f, false, null, "Cut_CS7_3", 1),
                new Cut(null, "Cut_S_N7_04", "탑 아래 우유 두 병을 두고 가는 사람은 그였다. 하나는 오늘, 하나는 내일. 8년째 같은 자리.", 8.5f, false, null, "Cut_V_N7_1", 0),
                new Cut(null, "Cut_S_N7_05", "길에서 넘어졌다. 그가 바로 앞에 있었는데 돌아보지 않았다. 꼬마만 옆에 앉아 무릎을 털어 줬다.", 8.5f, false, null, "Cut_V_CH07_Close", 3),
                new Cut(null, "Cut_S_N7_06", "정류장 한가운데서 두 팔을 흔들었다. 그는 내 쪽을 보고도 그냥 걸어갔다. 눈이 나를 지나쳐 먼 데에 닿아 있었다.", 8.5f, false, null, "Cut_V_CH15_Open", 0),
                ...
                new Cut(null, "Cut_S_N7_10", "그의 방 창가에 국화 한 다발이 있었다. 리본엔 이름이 없었다. 나는 그 꽃이 그를 위한 거라고 생각했다.", 8.5f, false, null, "Cut_V_CH18_Open", 2),
                new Cut(null, "Cut_S_N7_11", "꼬마는 그를 보면 늘 한 걸음 물러났다. 「저 사람은 아직 몰라.」 무엇을 모른다는 건지 묻지 못했다.", 8.5f, false, null, "Cut_V_CH17_Open", 1),
                new Cut(null, "Cut_S_N7_12", "나란히 창을 봤다. 유리엔 한 사람만 비쳤다. 나는 그게 나라고 믿었다. 그럼 옆에 선 그는 무엇일까.", 8.5f, false, null, "Cut_V_CH18_Open", 3),
            }
        };
        ...
        private static readonly Def CS8 = new Def
        {
            ...
            cuts = new[]
            {
                ...
                new Cut(null, "Cut_S_N8_08", "같은 태풍, 같은 정류장. 꼬마는 처음으로 곁에 없었다. 여섯 살이라던 아이가 여덟 해 전 그 밤을 알고 있었다.", 8.5f, false, null, "Cut_V_N8_3", 0),
                new Cut(null, "Cut_S_N8_09", "돌 세 개 옆에 소매가 찢어진 주황 우비가 개켜져 있었다. 어제 꼬마가 웃으며 한 말. 한 마리만 더 잡으민 되주.", 8.5f, false, null, "Cut_V_CH12_Close", 1),
        ...
        private static readonly Def EndA = new Def
        {
            ...
            cuts = new[]
            {
                ...
                new Cut(null, "Cut_S_EA_05", "무사 이추룩 늦언. 너 그거 어디서 배웠어. 8년. 나는 여덟 해 만에 처음으로 소리 내어 웃었다.", 8.5f, false, null, "Cut_V_MV_3", 1),
